...
<head>
    ...
    <link rel="shortcut icon" href="{{ url($site_settings->favicon_image) }}" type="image/x-icon">
            ...
            <div id="faq_accordion" class="faq-accordion accordion mb-5">
                @foreach ($faq as $index => $item)
                    <div class="accordion-item">
                        <h5 class="accordion-header" id="faq-accordion-heading-{{ $index + 1 }}">
                            <button class="accordion-button {{ $index === 0 ? 'collapsed' : '' }}" type="button" data-bs-toggle="collapse"
                                    data-bs-target="#faq-accordion-collapse-{{ $index + 1 }}" aria-expanded="{{ $index === 0 ? 'true' : 'false' }}"
                                    aria-controls="faq-accordion-collapse-{{ $index + 1 }}">
                                {{ $item->title }}
                            </button>
                        </h5>
                        <div id="faq-accordion-collapse-{{ $index + 1 }}" class="accordion-collapse collapse {{ $index === 0 ? 'show' : '' }}"
                            aria-labelledby="faq-accordion-heading-{{ $index + 1 }}" data-bs-parent="#faq_accordion">
