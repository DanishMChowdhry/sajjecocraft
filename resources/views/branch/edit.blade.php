                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('branches.update',$branch->id) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" value="{{ $branch->title }}" name="title" value="{{ old('title') }}">
                        </div>
                        <div class="mb-3">
                            <label for="email_address" class="form-label">Email Address</label>
                            <input type="email" class="form-control" id="email_address" value="{{ $branch->email_address }}" name="email_address" value="{{ old('email_address') }}">
                        </div>
                        <div class="mb-3">
                            <label for="phone_number" class="form-label">Phone Number</label>
                            <input type="text" class="form-control" id="phone_number" value="{{ $branch->phone_number }}" name="phone_number" value="{{ old('phone_number') }}">
                        </div>
                        <div class="mb-3">
